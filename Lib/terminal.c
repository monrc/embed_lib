...
SEMANTIC_ERROR:
	if (stTerminal.recvLen)	//缓存最新的数据长度，复位接收及回显缓冲区
	{
		stTerminal.recvLast = stTerminal.recvLen;
	}
	stTerminal.recvLen = 0;
